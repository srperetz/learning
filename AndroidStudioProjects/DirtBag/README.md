...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-dirtbag-dirtbag.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-dirtbag-dirtbag)

This repository contains the source code for the [DirtBag](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.dirtbag.dirtbag).

Please see the [issues](https://github.com.dirtbag.dirtbag/com-dirtbag-dirtbag/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about DirtBag? Ask away on the [com-dirtbag-dirtbag discussion forum](https://groups.google.com/forum/#!forum/com-dirtbag-dirtbag).

<a href="https://play.google.com/store/apps/details?id=com.dirtbag.dirtbag" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.dirtbag.dirtbag__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.dirtbag.dirtbag__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.dirtbag.dirtbag.R__) will now be renamed
...
signed with a different key.  Manually uninstall DirtBag from your device and
...
DirtBag is a result of a template project I've developed over the years as well as
...
DirtBag is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.dirtbag.dirtbag/com-dirtbag-dirtbag/contributors) on
...
[pull requests](https://github.com.dirtbag.dirtbag/com-dirtbag-dirtbag/pulls).
